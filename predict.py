...
def process_image(image_path):
    ...
    # Convert to numpy - 244x244 image w/ 3 channels (RGB)
...
def predict_data(image_tensor, model, device, cat_to_name, top_k):
    ...
    top_probs = np.array(top_probs.detach())[
        0]  # This is not the correct way to do it but the correct way isnt working thanks to cpu/gpu issues so I don't care.
